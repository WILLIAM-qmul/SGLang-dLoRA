...
class TpModelWorker:
    ...
    def __init__(
        ...
        lora_merge_mode: str = "merge",  # 新增参数
    ):
        # Parse args
        ...
        # True 表示合并 (W+AB)X；False 表示非合并 WX+ABX
        self.merge_lora_enabled: bool = (lora_merge_mode != "unmerge")
        ...
        self.model_runner = ModelRunner(
            ...
            merge_lora_enabled=self.merge_lora_enabled,  # 传递参数
        )
