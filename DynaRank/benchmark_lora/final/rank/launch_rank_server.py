...
def build_sglang_cmd(args, port:  int, gpu_id: int) -> str:
    ...
    if args.enable_credit_schedule_prefill:
        cmd += "--enable-credit-schedule-prefill "
    if args.enable_decode_credit_schedule:
        cmd += "--enable-decode-credit-schedule "
...
if __name__ == "__main__": 
    ...
    # Batching
    parser.add_argument("--enable-credit-schedule-prefill", action="store_true")
    parser.add_argument("--enable-decode-credit-schedule", action="store_true")
